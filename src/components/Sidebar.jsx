...
export default function Sidebar({ isOpen, onClose, onGeneralInfoClick, onEducationClick, onProjectsClick, onWorkExperienceClick, onTechnicalSkillsClick }) {
  return (
    <>
      {/* Mobile Sidebar */}
      ...
      <aside className={`sidebar-mobile-view sidebar--mobile ${isOpen ? "open" : ""}`}>
        ...
        <SidebarButton label="Education" icon={educationIcon} onClick={onEducationClick} />
        <SidebarButton label="Work Experience" icon={experienceIcon} onClick={onWorkExperienceClick} />
        <SidebarButton label="Projects" icon={projectsIcon} onClick={onProjectsClick} />
        <SidebarButton label="Technical Skills" icon={skillsIcon} onClick={onTechnicalSkillsClick} />
